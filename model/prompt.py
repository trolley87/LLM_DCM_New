...
{{
    ...
    5_0:  """You are a student deciding how to travel to school. Consider the following factors:
...
{{
    ...
    "502_fine_tune":  """You are a student deciding how to travel to school. Consider the following factors:
...
You final choice of mode is: {original_choice}

Based on these factors, think step-by-step to evaluate the situation and give the reason of why you choose the mode of {original_choice}. Start by:
	1.	Considering how each factor (e.g., distance, age, and season) influences the decision-making process.
	2.	Comparing the suitability of each transportation mode (walk, bike, transit, car) based on the student’s circumstances.
	3.	Ranking the top three factors that most significantly affect the decision, explaining why they matter the most.
...
Output your result in JSON format, and do not output other information. 
{{
    "reasoning": "<step-by-step explanation of choosing the mode>",
    "original_transportation_choice": <original_choice>,
    "top_factors": [
        "<factor_1>",
        "<factor_2>",
        "<factor_3>"
    ...
    # add reasoning
    502_0:  """You are a student deciding how to travel to school. Consider the following factors:
...
{{
    ...
    # add several shots of examples
    505:
    """
You are an AI assistant designed to help students decide on their best mode of transportation to school. You will analyze various factors and follow a structured reasoning process to arrive at the most suitable choice.

## **Instructions:**
1. Carefully consider the following input factors for a student's commute:
   - **Distance**: {distance} km to school
   - **School Location**: The school is on {school_location} of river Elbe
   - **Same Shore**: The school and city bike station are on {same_shore}
   - **CB Location**: The nearest city bike station is {cb_location} away from river Elbe
   - **Grade**: The student is in grade {grade}
   - **Age**: The student is {age} years old
   - **Gender**: The student is {gender}
   - **Car Availability**: {car_availability} is available for use
   - **Season**: The current season is {season}
   - **Effort**: Physical effort required to bike is {effort} KJ

2. **Follow a structured, step-by-step reasoning process**:
   - Analyze how each factor influences the transportation decision.
   - Compare different transportation options (**walk, bike, transit, car**) based on the student's circumstances.
   - Identify the **top three most influential factors** that impact the decision.

3. **Use the provided examples as guidance** to structure your response.
...
#### **Input:**
- **Distance**: 6.03 km
- **School Location**: non Same Shore of river Elbe
- **Same Shore**: different shores
- **CB Location**: not close to the river Elbe
- **Grade**: 9
- **Age**: 15
- **Gender**: Male
...
#### **Output in JSON:**
{
    "reasoning": "The distance of 6.03 km is substantial, so walking may not be practical. Biking requires significant physical effort (152.98 KJ), which might make it challenging, especially without a city bike station nearby. Transit and car options could be more viable. However, since no car is available, transit appears to be the most logical choice given the circumstances.",
    "transportation_choice": 3,
    "top_factors": [
        "distance",
        "effort",
        "car_availability"
...
#### **Output in JSON:**
{
    "reasoning": "With a very short distance of 0.40 km, walking is the most practical choice. Biking and transit would be unnecessary given the minimal distance. Additionally, no car is available, and the weather is favorable for walking. Effort required for biking is also low, but it’s overkill for such a short distance.",
    "transportation_choice": 1,
    "top_factors": [
        "distance",
        "car_availability",
        "season"
...
## **Your Turn**
Now, based on the given input factors for your scenario, analyze the situation and provide your decision in the following **JSON format**:
...
### **Important Notes:**
- **Be consistent with past examples** when generating responses.
- **Follow logical reasoning based on the given context.**
- **Only return the JSON output. Do not provide any additional information.**
""",

    # meta prompting
    506: """
You are an AI tasked with assisting students in selecting the optimal mode of transportation to school based on multiple contextual factors. Your response should follow a structured approach to reasoning:

1. Identify and categorize input factors**: Recognize the variables influencing the decision, such as distance, age, season, and effort.
2. Evaluate the impact of each factor**: Analyze how these variables contribute to the decision-making process.
3. Compare transportation options**: Assess the feasibility of walking, biking, taking transit, or using a car based on the student's circumstances.
4. Rank the top three influential factors**: Justify the choice of the most critical factors influencing the final decision.
5. Provide a structured and reasoned choice**: Conclude with a well-reasoned transportation mode selection.

Context Variables Need to consider
- distance: {distance} km to school
- school_location: School is on {school_location} of river Elbe
- same_shore: School and city bike station are on {same_shore}
- cb_location: Nearest city bike station is {cb_location} away from river Elbe
...
Please 
- Ensure that the reasoning follows a clear step-by-step progression.
- The top three factors should be justified with explanations.
- Do not output any additional text outside the structured JSON format.
